## Nopthon 的 Leetcode 刷题仓库

> [!note]
>
>  和 [Nopthon/LeetCode-Reviewer](https://github.com/Nopthon/LeetCode-Reviewer) 一样都是年久失修的史山代码，有时还会出现 CORS 问题（我偷懒直接用 Allow CORS 插件解决了）

##### 背景

这个人上大学之前没有学过编程，大一一年进行了 C 语言的初步学习并且在课余时间速通了 OI 基础（为了转专业）；大二为了保持先前刷题的手感，遂从 Luogu 跳转到 LeetCode 开始常态化的刷题（事实是现在已经从 LeetCode 跳回了 Luogu 和 Codeforces）

（这个人并没有想打 XCPC 的打算，首先他的 Codeforces Ratings 只有 1400，压根进不了校队；其次他的 Div3 最好战绩是 5/7 ，甚至没有 AK Div3 的能力）
